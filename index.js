...
const questions = [
  {
    ...
    validate: (answer) => {
      if (answer.length > 3) {
        return console.log(
          "Your text must be up to three characters! Please try again"
        );
      }
      return true;
    },
  },
  {
    type: "input",
    message:
      "What is your logo s text color? Please enter a color keyword or a hexadecimal number",
    name: "textColor",
  },
  {
    type: "list",
  ...
  },
  {
    type: "input",
    message:
      "What is your background color? Please enter a color keyword or a hexadecimal number",
